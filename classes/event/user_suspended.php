...
/**
 * The tool_selfsignuphardlifecycle user suspended event class.
 *
 * @package    tool_selfsignuphardlifecycle
 * @copyright  2022 Alexander Bias, lern.link GmbH <alexander.bias@lernlink.de>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class user_suspended extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventusersuspended', 'tool_selfsignuphardlifecycle');
    }
    ...
    public function get_description() {
        if (isset($this->other['overridden']) && $this->other['overridden'] == true) {
            return get_string(
                'eventusersuspendedoverridden_desc',
